...
SPECS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "style": "marketing",
        "keywords": ["LLM", "privacy", "open source"],
    ...
    },
    {
        ...
        "content_type": "twitter",
        "style": "marketing",
        "keywords": ["personal finance", "saving"],
        "tags": ["finance"],
        "created_days": -31,
        "engagement": "low",
    },
...
def reset_demo_rows(store: ContentStore) -> None:
    ...
    try:
        ...
        session.query(AgentMessage).filter(AgentMessage.thread_id == demo_thread_id(store)).delete(
            synchronize_session=False
        )
...
def seed_agent_thread(store: ContentStore) -> None:
    ...
    try:
        ...
        session.add_all(
            [
                AgentMessage(
                    thread_id=demo_thread_id(store),
                    role="user",
...
def main() -> None:
    ...
    print(
        f"60d performance:  {len(perf['by_type'])} content_types, top performer = "
